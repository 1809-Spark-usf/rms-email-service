...
/**
 * The Class AwsCredentials. Creates connection to amazon SES console.
 * 
...
public class AwsCredentials {
	...
	/**
	 * Creates the AWS credentials. Using an AWS key and secret to access the
	 * console remotely
	 *
	...
	private AWSCredentials createAWSCredentials() throws IOException {
		...
		AWSCredentials credentials = new BasicAWSCredentials(System.getenv("REFORCE_AWS_KEY"),
				System.getenv("REFORCE_AWS_SECRET"));
		return credentials;
